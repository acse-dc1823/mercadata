...
CATEGORY_KEYWORDS = {
    "frutas": ["banana", "manzana", "naranja", "fresa", "uvas", "pera", "kiwi", "sandía", "melon", 
               "melocoton", "limon", "platano", "cereza", "ciruela", "mandarina", "mango", "pomelo",
               "aguacate", "piña", "coco", "papaya", "granada", "higo", "guayaba", "mora"],
    "lácteos": ["leche", "yogur", "queso", "mantequilla", "crema", "nata", "kefir", "feta",
                "mozzarella", "parmesano", "burrata", "cheddar", "gouda", "provolone"],
    "carnes": ["pollo", "res", "cerdo", "jamon", "salchicha", "mortadela", "chorizo", "huevo",
               "pechuga", "chuleta"],
    "pescado": ["salmón", "atun", "bacalao", "merluza", "lubina", "sardina", "pulpo", "calamar",
                "gamba", "rodaballo", "boquerones"],
    "bebidas": ["agua", "jugo", "refresco", "vino", "cerveza", "café", "te"],
    "panadería": ["pan", "bollos", "baguette", "pan integral"],
    "granos y cereales": ["pasta", "arroz", "lentejas", "quinoa", "cuscus", "harina", "avena",
                          "maiz", "garbanzos", "trigo", "cereales", "alubias", "penne", 
                          "tortiglioni", "medialuna", "canelones", "tortillas"],
    "limpieza": ["detergente", "jabón", "limpiador", "esponja"],
    "snacks": ["patatas", "galletas", "chocolates", "golosinas", "frutos secos", "palomitas",
               "nachos", "hummus", "salsa", "dip"],
    "verduras": ["rucula", "lechuga", "tomate", "cebolla", "ajo", "pimiento", "calabaza",
                 "zanahoria", "berenjena", "calabacin", "pepino", "judias", "espinacas",
                 "cilantro", "perejil", "apio", "remolacha", "coliflor", "brocoli"],
    "higiene": ["shampoo", "jabón", "pasta de dientes", "desodorante", "cepillo de dientes",
                "toallas sanitarias", "pañales", "crema", "preservativo"],
